          ...
          <div className={styles.sections}>
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                предпринимаемые ИП Абдурахимов Амир Баходирович (далее —
                Оператор).
              </p>
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                Оператора itishkino@yandex.ru с пометкой «Актуализация
                персональных данных».
              </p>
              ...
              <p>
                ...
                электронный адрес Оператора itishkino@yandex.ru с пометкой
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                в сети Интернет по адресу https://itishkino.ru.
              </p>
            </section>
          </div>
        </div>
